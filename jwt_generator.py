...
class MainFrame(wx.Frame):
  def __init__(self, *args, **kwds):
    ...
    self.checkbox_1 = wx.CheckBox(self.panel_1, wx.ID_ANY, "Add iat and exp")
    self.spin_ctrl_1 = wx.SpinCtrl(self.panel_1, wx.ID_ANY, "3600", min=0, max=86400)
    self.text_ctrl_1 = wx.TextCtrl(self.panel_1, wx.ID_ANY, "{\n  \"sub\": \"1234567890\",\n  \"name\": \"John Doe\",\n  \"admin\": true\n}", style=wx.TE_MULTILINE | wx.TE_WORDWRAP)
    self.text_ctrl_2 = wx.TextCtrl(self.panel_1, wx.ID_ANY, "private.rsa256.key")
    self.button_4 = wx.Button(self.panel_1, wx.ID_ANY, "...", style=wx.BU_EXACTFIT)
    self.text_ctrl_3 = wx.TextCtrl(self.panel_1, wx.ID_ANY, "public.rsa256.key")
    self.button_5 = wx.Button(self.panel_1, wx.ID_ANY, "...", style=wx.BU_EXACTFIT)
    self.text_ctrl_4 = wx.TextCtrl(self.panel_1, wx.ID_ANY, "Token here...", style=wx.TE_CHARWRAP | wx.TE_MULTILINE)
    self.button_6 = wx.Button(self.panel_1, wx.ID_ANY, "Decode Jwt Token")
    self.button_1 = wx.Button(self.panel_1, wx.ID_ANY, "Encode Jwt Token")
    self.button_2 = wx.Button(self.panel_1, wx.ID_ANY, "Copy Token")
    self.button_3 = wx.Button(self.panel_1, wx.ID_EXIT, "")
  ...
  def __do_layout(self):
    ...
    sizer_8 = wx.StaticBoxSizer(wx.StaticBox(self.panel_1, wx.ID_ANY, "Token"), wx.VERTICAL)
    sizer_4 = wx.BoxSizer(wx.VERTICAL)
    sizer_7 = wx.StaticBoxSizer(wx.StaticBox(self.panel_1, wx.ID_ANY, "Key"), wx.VERTICAL)
    grid_sizer_2 = wx.FlexGridSizer(2, 3, 5, 0)
    sizer_6 = wx.StaticBoxSizer(wx.StaticBox(self.panel_1, wx.ID_ANY, "Body"), wx.VERTICAL)
    sizer_5 = wx.StaticBoxSizer(wx.StaticBox(self.panel_1, wx.ID_ANY, "Options"), wx.VERTICAL)
    grid_sizer_1 = wx.FlexGridSizer(4, 2, 0, 0)
    label_1 = wx.StaticText(self.panel_1, wx.ID_ANY, "Type:")
    grid_sizer_1.Add(label_1, 1, wx.ALL | wx.EXPAND, 5)
    label_2 = wx.StaticText(self.panel_1, wx.ID_ANY, "JWT")
    grid_sizer_1.Add(label_2, 1, wx.ALL | wx.EXPAND, 5)
    label_3 = wx.StaticText(self.panel_1, wx.ID_ANY, "Algorithm: ")
    grid_sizer_1.Add(label_3, 1, wx.ALL | wx.EXPAND, 5)
    label_4 = wx.StaticText(self.panel_1, wx.ID_ANY, "RS256")
    grid_sizer_1.Add(label_4, 1, wx.ALL | wx.EXPAND, 5)
    label_6 = wx.StaticText(self.panel_1, wx.ID_ANY, "IssuedAt and Expire:")
    grid_sizer_1.Add(label_6, 1, wx.ALL | wx.EXPAND, 5)
    grid_sizer_1.Add(self.checkbox_1, 1, wx.ALL | wx.EXPAND, 5)
    label_5 = wx.StaticText(self.panel_1, wx.ID_ANY, "Expire: (seconds)")
    grid_sizer_1.Add(label_5, 1, wx.ALL | wx.EXPAND, 5)
    grid_sizer_1.Add(self.spin_ctrl_1, 1, wx.EXPAND | wx.LEFT | wx.RIGHT, 5)
    grid_sizer_1.AddGrowableCol(1)
    sizer_5.Add(grid_sizer_1, 1, wx.BOTTOM | wx.EXPAND, 5)
    sizer_4.Add(sizer_5, 0, wx.ALL | wx.EXPAND, 5)
    sizer_6.Add(self.text_ctrl_1, 29, wx.ALL | wx.EXPAND, 5)
    sizer_4.Add(sizer_6, 1, wx.EXPAND | wx.LEFT | wx.RIGHT, 5)
    label_7 = wx.StaticText(self.panel_1, wx.ID_ANY, "Private: *")
    ...
    label_8 = wx.StaticText(self.panel_1, wx.ID_ANY, "Public:")
    ...
    sizer_7.Add(grid_sizer_2, 1, wx.BOTTOM | wx.EXPAND, 5)
    sizer_4.Add(sizer_7, 0, wx.ALL | wx.EXPAND, 5)
    sizer_3.Add(sizer_4, 1, wx.EXPAND, 0)
    sizer_8.Add(self.text_ctrl_4, 1, wx.ALL | wx.EXPAND, 5)
    sizer_3.Add(sizer_8, 1, wx.ALL | wx.EXPAND, 5)
    sizer_2.Add(sizer_3, 1, wx.EXPAND, 0)
    sizer_9.Add(self.button_6, 1, wx.ALL | wx.EXPAND, 5)
    sizer_9.Add(self.button_1, 1, wx.ALL | wx.EXPAND, 5)
    sizer_9.Add(self.button_2, 1, wx.ALL | wx.EXPAND, 5)
    sizer_9.Add(self.button_3, 1, wx.ALL | wx.EXPAND, 5)
